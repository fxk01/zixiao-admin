...
fs.readFile('./dist/src/detail/login.html', 'utf8', function (err, data) {
  if (err) {
    throw err;
  }
  fs.writeFile('./dist/src/detail/login.html', minify(data,{removeComments: true,collapseWhitespace: true,minifyJS:true, minifyCSS:true}), function() {
    console.log('success/login.html');
  });
});
